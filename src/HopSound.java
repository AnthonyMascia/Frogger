...
//Class the contains sound Frogger makes everytime he moves
public class HopSound implements Clip{


	@Override
	public void start() {
		try {
	        AudioInputStream audio = AudioSystem.getAudioInputStream(new File("froggerHop.wav"));
