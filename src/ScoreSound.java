...
//Sound that plays everytime user reaches a lily pad
public class ScoreSound implements Clip{

	@Override
	public void start() {
		try {
	        AudioInputStream audio = AudioSystem.getAudioInputStream(new File("1up.wav"));
