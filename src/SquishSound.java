...
//Sound that plays everytime Frogger hits a car
public class SquishSound implements Clip{

	@Override
	public void start() {
		try {
	        AudioInputStream audio = AudioSystem.getAudioInputStream(new File("squish.wav"));
